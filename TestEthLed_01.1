...
void app_main(void)
{
  ...
  eth_out_config.pin_bit_mask = (1ULL << ETH_RXD0) | (1ULL << ETH_RXD1) | (1ULL << ETH_CRS_DV);
  eth_out_config.pull_up_en = GPIO_PULLUP_ENABLE;
  eth_out_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
  ...
  gpio_set_level(ETH_TXEN, 0);
  gpio_set_level(ETH_CRS_DV, 1);
  ...
  while (1)
  {
    ...
    gpio_set_level(ETH_RXD0, 0);
    gpio_set_level(ETH_RXD1, 0);
